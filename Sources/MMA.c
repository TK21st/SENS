...
int8 MMA8451_Freedom_Init_50Hz(LDD_TDeviceData *DeviceDataPtr, struct AccelSensor *pthisAccel)
{
	...
	I2C_Buf[1] = 0x00;
	MMA_I2C_SENT_FLAG = FALSE; //clear I2C_SENT_FLAG
	...
	while ((!MMA8451_I2C_Error) && !MMA_I2C_SENT_FLAG);
